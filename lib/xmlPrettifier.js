xmlPrettifier = (function() {
  ...
  function parse(input) {
    var options = arguments.length > 1 ? arguments[1] : {},
        ...
        peg$c90 = function(startTag) {
        			indention += 1;
        			return true
        		},
        peg$c91 = void 0,
        peg$c92 = function(content) { return content },
        peg$c93 = function(startTag, contents) {
        			indention -= 1;
        			return true
        		},
        peg$c94 = function(startTag, contents, endTag) {
        			return indent(indention - 1) + startTag + '\n' + (contents && contents.length > 0 ? contents.join('\n') + '\n' : '') + indent(indention - 1) + endTag
        		},
        peg$c95 = function(tag) {
        ...
        peg$c100 = function(qid, value) {
        			return ' ' + qid + (value ? '=' + value : '')
        		},
        peg$c101 = { type: "other", description: "attribute value" },
        peg$c102 = "<?",
        peg$c103 = { type: "literal", value: "<?", description: "\"<?\"" },
        peg$c104 = function(id, content) {
        			return '<?' + id + ' ' + content
        		},
        peg$c105 = "?>",
        peg$c106 = { type: "literal", value: "?>", description: "\"?>\"" },
        peg$c107 = function(tail) { return ' ' + tail },
        peg$c108 = { type: "any", description: "any character" },
        peg$c109 = function(head, tail) { return head + tail },
        peg$c110 = "<?xml",
        peg$c111 = { type: "literal", value: "<?xml", description: "\"<?xml\"" },
        peg$c112 = function(encoding) { return encoding },
        peg$c113 = function(standalone) { return standalone },
        peg$c114 = function(version, encoding, standalone) {
        			return '<?xml ' + version + ( encoding ? ' ' + encoding : '' ) + ( standalone  ? ' ' + standalone : '' ) + ' ?>'
        		},
        peg$c115 = "version",
        peg$c116 = { type: "literal", value: "version", description: "\"version\"" },
        peg$c117 = function(version) {
        			return 'version="' + version + '"'
        		},
        peg$c118 = "encoding",
        peg$c119 = { type: "literal", value: "encoding", description: "\"encoding\"" },
        peg$c120 = function(encoding) { return 'encoding="' + encoding + '"' },
        peg$c121 = "standalone",
        peg$c122 = { type: "literal", value: "standalone", description: "\"standalone\"" },
        ...
        peg$c124 = { type: "other", description: "CDATA" },
        peg$c125 = "<![CDATA[",
        peg$c126 = { type: "literal", value: "<![CDATA[", description: "\"<![CDATA[\"" },
        peg$c127 = function(content) { return '<![CDATA[' + content },
        peg$c128 = "]]>",
        peg$c129 = { type: "literal", value: "]]>", description: "\"]]>\"" },
        peg$c130 = { type: "other", description: "comment" },
        peg$c131 = "<!--",
        peg$c132 = { type: "literal", value: "<!--", description: "\"<!--\"" },
        peg$c133 = function(content) { return '<!--' + content },
        peg$c134 = "-->",
